...
export default function Data(){
    ...
    return(
        <div className="h-screen w-screen flex bg-white flex-col items-center ">
            <button className=" bg-white text-black font-mono px-5 py-2 border rounded-lg translate-y-10  hover:shadow-xl hover:bg-gray-300 mx-3" onClick={() =>router.back()}>Back</button>
